...
describe("coerceSetPatch", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      value: "feat/existing",
      opts: {},
      patch: { mergeBaseOverride: "feat/existing" },
    },
    {
      name: "epic mergeBase stores mergeBaseOverride",
      kind: "epic" as const,
      field: "mergeBase",
      value: "feat/epic-base",
      opts: {},
      patch: { mergeBaseOverride: "feat/epic-base" },
    },
    {
      name: "story mergeBase --clear clears mergeBaseOverride",
      kind: "story" as const,
      field: "mergeBase",
      value: undefined,
      opts: { clear: true },
      patch: { mergeBaseOverride: null },
    },
    {
      name: "boolean false",
      kind: "task" as const,
    ...
    },
    {
      ...
      opts: {},
      patch: { commits: ["0123456789abcdef0123456789abcdef01234567"] },
    },
    {
