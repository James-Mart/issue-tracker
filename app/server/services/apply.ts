...
// (retro, status, qa, commits, noDiff, appended, branchName, worktreePath, worktreeBlockedReason, worktreeSetupFailed, prUrl, merged, review, assignee,
// needsAttention, attentionReason, archived, workspace, setupCommand, mergePolicy, labels, supportingDocs,
